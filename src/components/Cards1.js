...
const Cards1 = () => {
    return (
        <div className="flex justify-center items-center p-3 w-full flex-col md:flex-row">
            <div className="text-white dark:text-black w-full sm:p-12 md:p-12 lg:p-32 lg:mt-0 md:w-[50%] flex flex-col gap-6 text-center md:text-left">
                <h1 className="text-[2.3em] md:text-[2.5em]">
            ...
            <div className="w-full md:w-[50%]">
                <img
                    ...
                    src="https://cdn.glitch.global/cc7363c3-ff3e-4258-979e-981af8a55998/developer-dark.3f07bd13.svg?1718443109379"
                    className="mx-auto"
                />
            </div>
        </div>

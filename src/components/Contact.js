            ...
            <div className='w-full lg:w-auto flex md:justify-center '>
                <form className='bg-[#100D25] dark:bg-white dark:text-black flex flex-col gap-8 text-white p-8 rounded-2xl w-full lg:w-[520px] md:w-[520px] sm:w-[90%] dark:border-2 dark:border-black '>
                    <div className='flex flex-col gap-3'>
                        ...
                        <p className="text-white font-bold text-6xl text-left dark:text-black">Contact.</p>
                    </div>
                    <div className='text-left font-bold flex flex-col gap-3'>
                        <label htmlFor="name" className='text-lg'>Your Name</label>
                        <input type='text' id="name" placeholder='Whats your good name?' required className='bg-[#151030]  p-4 rounded-lg focus:outline-none focus:border-none dark:bg-slate-100' />
                    </div>
                    <div className='text-left font-bold flex flex-col gap-3'>
                        <label htmlFor="email" className='text-lg'>Your Email</label>
                        <input type='email' id="email" placeholder='Whats your email address?' required  className='bg-[#151030]  p-4 rounded-lg focus:outline-none focus:border-none dark:bg-slate-100' />
                    </div>
                    <div className='text-left font-bold flex flex-col gap-3'>

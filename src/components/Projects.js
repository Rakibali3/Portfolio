  ...
  return (
    <div className="flex flex-col gap-6 p-3 justify-center ">
      ...
      <div className="flex flex-wrap gap-8 items-center justify-center ">
        {/* card1 */}
        <div data-aos="flip-right" className="w-[360px]  p-1  text-white border-[#8A4CA8] border-2 tex shadow-[#8A4CA8] shadow-md rounded-2xl ease-in duration-300 hover:scale-105">
        ...
        {/* card2 */}
        <div  data-aos="flip-left" className="w-[360px]  p-1  text-white border-[#8A4CA8] border-2 tex shadow-[#8A4CA8] shadow-md rounded-2xl ease-in duration-300 hover:scale-105">
          <div className="relative">
            <img
